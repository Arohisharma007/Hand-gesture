...
#PCM IMAGE
image = Image.open("C:\\Users\\ASUS\\OneDrive\\Desktop\\PROJECT\\HAND_GESTURE\\hand.png")
...
b1.place(x=10,y=600)
image = Image.open("C:\\Users\\ASUS\\OneDrive\\Desktop\\PROJECT\\HAND_GESTURE\\MEDIA.png")
# Resize the image using resize() method
...
image = Image.open("C:\\Users\\ASUS\\OneDrive\\Desktop\\PROJECT\\HAND_GESTURE\\mouse.png")
# Resize the image using resize() method
resize_image = image.resize((350, 350))
img = ImageTk.PhotoImage(resize_image)
# create label and add resize image
...
image = Image.open("C:\\Users\\ASUS\\OneDrive\\Desktop\\PROJECT\\HAND_GESTURE\\shopping.png")
# Resize the image using resize() method
resize_image = image.resize((350, 350)) 
img = ImageTk.PhotoImage(resize_image)
# create label and add resize image
...
image = Image.open("C:\\Users\\ASUS\\OneDrive\\Desktop\\PROJECT\\HAND_GESTURE\\other.png")
 # Resize the image using resize() method
resize_image = image.resize((350, 350)) 
img = ImageTk.PhotoImage(resize_image)
# create label and add resize image
